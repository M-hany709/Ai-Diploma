...
from db_Political import libraryp
from mylibrary import add_book

db_Political=libraryp("booksPolitical.db")


def open_root_Political():
    rootPolitical=Toplevel()
    rootPolitical.attributes("-fullscreen", True)
    rootPolitical.title("Library system mangement")
    rootPolitical.resizable(False,False)
    rootPolitical.configure(bg="#d8d9ff")
    l=Label(rootPolitical,text="Choose the Political book to put it in your Library",font=("Arial",28,"bold"),fg="#b8860b" , bg="#d8d9ff")
    l.pack(pady=50)
    bpack=Button(rootPolitical,text="pack",command=rootPolitical.destroy ,font=("Arial",28,"bold"),fg="#b8860b" , bg="#1e213f",width=10,height=1)
...
#__________________________list_frame______________________
    list_frame=Frame(rootPolitical,bg="gray")
...
#____________________table frame_______________________________________
    ...
    tree_frame=Frame(rootPolitical,bg="white")
