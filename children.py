...
from db_children import libraryc
from mylibrary import add_book


db_children=libraryc("bookschildren.db")

def open_root_children():
    rootchildren=Toplevel()
    rootchildren.attributes("-fullscreen", True)
    rootchildren.title("Library system mangement")
    rootchildren.resizable(False,False)
    rootchildren.configure(bg="#d8d9ff")
    l=Label(rootchildren,text="Choose the Children book to put it in your Library",font=("Arial",28,"bold"),fg="#b8860b" , bg="#d8d9ff")
    l.pack(pady=50)
    bpack=Button(rootchildren,text="pack",command=rootchildren.destroy ,font=("Arial",28,"bold"),fg="#b8860b" , bg="#1e213f",width=10,height=1)
...
#__________________________list_frame______________________
    list_frame=Frame(rootchildren,bg="gray")
...
#____________________table frame_______________________________________
    ...
    tree_frame=Frame(rootchildren,bg="white")
