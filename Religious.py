...
from db_Religious import libraryr
from mylibrary import add_book



db_Religious=libraryr("booksReligious.db")

def open_root_Religious():
    rootReligious=Toplevel()
    rootReligious.attributes("-fullscreen", True)
    rootReligious.title("Library system mangement")
    rootReligious.resizable(False,False)
    rootReligious.configure(bg="#d8d9ff")
    l=Label(rootReligious,text="Choose the Religies book to put it in your Library",font=("Arial",28,"bold"),fg="#b8860b" , bg="#d8d9ff")
    l.pack(pady=50)
    bpack=Button(rootReligious,text="pack",command=rootReligious.destroy ,font=("Arial",28,"bold"),fg="#b8860b" , bg="#1e213f",width=10,height=1)
...
#__________________________list_frame______________________
    list_frame=Frame(rootReligious,bg="gray")
...
#____________________table frame_______________________________________
    ...
    tree_frame=Frame(rootReligious,bg="white")
