...
from db_novel import libraryn
from mylibrary import add_book

db_novel=libraryn("booksnovel.db")


def open_root_novels():
    rootnovel=Toplevel()
    rootnovel.attributes("-fullscreen", True)
    rootnovel.title("Library system mangement")
    rootnovel.resizable(False,False)
    rootnovel.configure(bg="#d8d9ff")
    l=Label(rootnovel,text="Choose the Political book to put it in your Library",font=("Arial",28,"bold"),fg="#b8860b" , bg="#d8d9ff")
    l.pack(pady=50)
    bpack=Button(rootnovel,text="pack",command=rootnovel.destroy ,font=("Arial",28,"bold"),fg="#b8860b" , bg="#1e213f",width=10,height=1)
...
#__________________________list_frame______________________
    list_frame=Frame(rootnovel,bg="gray")
...
#____________________table frame_______________________________________
    ...
    tree_frame=Frame(rootnovel,bg="white")
